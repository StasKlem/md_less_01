...
final class SettingsModelsTests: XCTestCase {
    func testLLMSettingsDecodingFallsBackToDefaultModelForUnknownStoredModel() throws {
        ...
        XCTAssertEqual(settings.maxTokens, LLMSettings.default.maxTokens)
    ...
    func testLLMSettingsDefaultUsesExpectedMaxTokens() {
        XCTAssertEqual(LLMSettings.default.maxTokens, LLMSettings.defaultMaxTokens)
    }
}
